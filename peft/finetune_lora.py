...
LastEditTime: 2023-08-29 00:11:36
'''
"""
mkdir -p /home/yhk/github/DeepSpeed/Chat/output/lora
deepspeed finetune_lora.py --train_path llm_dataset/CodeInstruction/ \
   --per_device_train_batch_size 2 \
   --model_dir llm_model/lmsys/vicuna-7b-v1.3/ \
   --gradient_accumulation_steps 1 \
   --lora_r 8 \
   --zero_stage 2 \
   --output_dir output/lora \
   > output/lora/training.log
"""
...
def set_args():
    ...
    parser.add_argument('--train_path', default='/home/yhk/github/DeepSpeed/CodeInstruction/', type=str, help='')
...
def main():
    ...
    model = get_peft_model(model, lora_config) # 这里使用lora配置后，会自动冻结其余部分参数，只有lora部分可训练
    ...
    for epoch in range(args.num_train_epochs):
        ...
        if args.output_dir is not None:
            ...
            save_path = os.path.join(args.output_dir,"lora_tune_epoch_{}".format(epoch))
